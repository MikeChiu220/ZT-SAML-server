...
$config = [
    ...
    'default-sp' => [
        ...
        // The entity ID of this SP.	Mike[2024/09/09]
        // Can be NULL/unset, in which case an entity ID is generated based on the metadata URL.
        'entityID' => 'https://apacrd2.zentera.net/launcher',
    ...
    */
	...
	// use this custom authentication module	Mike[2024/09/09]
	'fido-auth' => array(
		'fidoauth:Fido',
	),
    'fido' => [
