...
//  'baseurlpath' => 'simplesaml/',
    ...
    */
     ...
     */
    'timezone' => 'Asia/Taipei',		// Mike[2024/09/09] null
     ...
     */
    'secretsalt' => 'randomsecretstring',	// Mike[2024/09/09] 'defaultsecretsalt',
     ...
     */
    'auth.adminpassword' => null,           // Mike[2024/09/09] '84433706',
    'usenewui' => false,                    // /
     ...
     */
    'debug' => [
        'saml' => true,			// Mike[2024/09/09] false -> true
        'backtraces' => true,
        'validatexml' => true,	// Mike[2024/09/09] false -> true
    ],
     ...
     */
    'database.dsn' => 'mysql:host=localhost;dbname=zt',

    /*
     * SQL database credentials
     * Mike[2024/09/09]
     */
    'database.username' => 'ippbx',
    'database.password' => 'G722434310',
    'database.options' => [],
     ...
     */
    'enable.saml20-idp' => true,		// Mike[2024/09/09] false -> true
    ...
    'module.enable' => [
        'exampleauth' => true,		// Mike[2024/09/09] false -> true
        'fidoauth' => true,         // /
        'core' => true,
        'admin' => true,
        'saml' => true
     ...
     */
    'session.cookie.domain' => null,   // Mike[2024/09/09]
     ...
     */
    'session.cookie.secure' => true,   // Mike[2024/09/09]
    ...
    'session.cookie.samesite' => 'Lax',   // Mike[2024/09/09]
